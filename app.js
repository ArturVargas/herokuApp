...
const mongoUrl = 'mongodb+srv://devf31:cintaRoja31@cinta31-qbqwc.mongodb.net/test?retryWrites=true&w=majority'
            ...
            if (err) {
                ...
                newUser.save((err, user) => {
                    if (err) {
                        ...
                        return res.status(201).json({data: { email: params.email, user: params.userName }});
                    }
                });
            }
        })
